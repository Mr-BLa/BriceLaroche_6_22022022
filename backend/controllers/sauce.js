                ...
                switch (sauceObject) {
                    ...
                    case 0: 
                        if ((usersLiked.includes(userId) && totalLikes === 0) || (usersDisliked.includes(userId) && totalDislikes === 0)) {
                            ...
                            // Mise à jour de la sauce dans la base de données + Utilisation de'$inc' de mongoDB pour l'incrémentation de [dislikes] à -1 et de'$pull' pour l'ajout de userId ds [usersDisliked]
